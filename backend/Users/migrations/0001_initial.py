# Generated by Django 3.2.9 on 2021-11-25 14:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('following', models.ManyToManyField(null=True, related_name='followers', through='Users.Relationship', to=settings.AUTH_USER_MODEL)),
